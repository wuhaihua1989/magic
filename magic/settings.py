...
CRONJOBS = [
    ('*/5 * * * *', 'apps.order.cron.test',), # '>> /var/log/cron.log >/dev/null 2>&1'
    ('*/5 * * * *', 'apps.electron.crontab.add_pin_or_similar_electron', '>> %s/logs/crontab.log' % BASE_DIR),
    # ('30 12 * * *', 'apps.electron.crontab.add_pin_or_similar_electron', '>> %s/logs/crontab.log' % BASE_DIR),
]
...
# 微信支付
APPID = 'wxe3e4307d3afefd87'
API_KEY = '4VgHD1VWDF0EVFnTRyXWO2JoBLzqdZJt'
MCH_ID = '1513349781'
